    ...
    axios
      ...
      .then((res) => {
        this.setState({
          ...
          location1:
            res.data[0].attendences[res.data[0].attendences.length - 1]
              .location,
          location2:
            res.data[1].attendences[res.data[1].attendences.length - 1]
              .location,
          timestamp1:
            res.data[0].attendences[res.data[0].attendences.length - 1]
              .timestamp,
      ...
      <div className="mx-2 mt-5">
        ...
        <Accordion>
          ...
          >
            ...
            <div className="d-flex col-md-4">
              <p>
                <strong>Worker Name:</strong> {this.state.name1}
                <br />
                <strong>Days Present:</strong> {this.state.days1}
                <br />
                <strong>Timestamp:</strong> {this.state.timestamp1}
                <br />
                <strong>Location:</strong> {this.state.location1}
              </p>
            </div>
          </AccordionSummary>
        ...
        <Accordion>
          ...
          >
            ...
            <div className="d-flex col-md-4">
              <p>
                <strong>Worker Name:</strong> {this.state.name2}
                <br />
                <strong>Days Present:</strong> {this.state.days2}
                <br />
                <strong>Timestamp:</strong> {this.state.timestamp2}
                <br />
                <strong>Location:</strong> {this.state.location2}
              </p>
            </div>
          </AccordionSummary>
          <AccordionDetails style={{ alignItems: "center" }}>
